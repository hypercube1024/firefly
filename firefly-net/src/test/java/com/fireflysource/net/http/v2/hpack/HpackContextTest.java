...
class HpackContextTest {
    ...
    void testStaticName() {
        ...
        assertTrue(entry.toString().startsWith("{S,2,:method: "));
    }
    ...
    void testJustRight() {
        ...
        assertNotNull(entry);
        assertTrue(entry.toString().startsWith("{D,0,foo: bar,"));
    }
    ...
    void testGetAddStatic() {
        ...
        assertEquals(methodGet, ctx.get(methodGet).getHttpField());
        assertNotSame(methodGet, ctx.get(methodGet).getHttpField());
