...
import com.fireflysource.net.websocket.decoder.payload.DeMaskProcessor;
import com.fireflysource.net.websocket.decoder.payload.PayloadProcessor;
import com.fireflysource.net.websocket.exception.MessageTooLargeException;
import com.fireflysource.net.websocket.exception.ProtocolException;
...
public class Parser {
    ...
    private boolean parsePayload(ByteBuffer buffer) {
        ...
        if (buffer.hasRemaining()) {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("{} Window: {}", policy.getBehavior(), BufferUtils.toDetailString(window));
            }
