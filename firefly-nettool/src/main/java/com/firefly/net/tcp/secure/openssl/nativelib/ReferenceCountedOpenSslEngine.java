...
import static com.firefly.net.tcp.secure.openssl.nativelib.EmptyArrays.EMPTY_CERTIFICATES;
import static com.firefly.net.tcp.secure.openssl.nativelib.EmptyArrays.EMPTY_JAVAX_X509_CERTIFICATES;
 ...
 */
public class ReferenceCountedOpenSslEngine extends SSLEngine implements ReferenceCounted, ApplicationProtocolSelector {
     ...
     *                             wrap or unwrap call.
     */
    ReferenceCountedOpenSslEngine(ReferenceCountedOpenSslContext context, String peerHost, int peerPort, boolean jdkCompatibilityMode) {
            ...
            try {
                ...
                for (; ; ) {
                    ...
                    if (remaining == 0) {
                        ...
                        writeEncryptedData(src, pendingEncryptedBytes);
                    }
                    for (; ; ) {
    ...
    public List<String> getSupportedApplicationProtocols() {
        return apn.getSupportedApplicationProtocols();
    }
    ...
    public final String[] getSupportedProtocols() {
        return OpenSsl.SUPPORTED_PROTOCOLS_SET.toArray(StringUtils.EMPTY_STRING_ARRAY);
    }
    ...
    private final class OpenSslSession implements SSLSession {
        ...
        public byte[] getId() {
            synchronized (ReferenceCountedOpenSslEngine.this) {
                if (id == null) {
                    return BufferUtils.EMPTY_BUFFER.array();
                }
                return id.clone();
            }
        }
        ...
        private void selectApplicationProtocol() throws SSLException {
            ...
            List<String> protocols = apn.getSupportedApplicationProtocols();
