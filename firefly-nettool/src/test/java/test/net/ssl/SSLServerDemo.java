        ...
        Server server = new AsynchronousTcpServer(
                ...
                new Handler() {
                    ...
                    public void sessionOpened(Session session) throws Throwable {
                        ...
                        final SSLEngine sslEngine = sslContextFactory.createSSLEngine(false);
                        System.out.println("server creates ssl engine elapsed time is " + (System.currentTimeMillis() - start));
                        SessionInfo info = new SessionInfo();
                        info.sslSession = new SSLSession(sslEngine, session, session1 -> System.out.println("server handshake finished!"),
