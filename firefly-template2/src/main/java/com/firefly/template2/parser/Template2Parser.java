...
public class Template2Parser extends Parser {
	...
	public static class OutputContext extends ParserRuleContext {
		...
		public TerminalNode OutputStringWithNewLine() { return getToken(Template2Parser.OutputStringWithNewLine, 0); }
	...
	public final OutputContext output() throws RecognitionException {
		...
		try {
			...
			setState(100);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << OutputString) | (1L << OutputStringWithNewLine) | (1L << OutputNewLine))) != 0)) ) {
