...
class TestQuotedStringTokenizer {
    /*
    ...
    /**
     * When encountering a Content-Disposition line during a multi-part mime
     * file upload, the filename="..." field can contain '\' characters that do
     * not belong to a proper escaping sequence, this tests
     * QuotedStringTokenizer to ensure that it preserves those slashes for where
     * they cannot be escaped.
     */
    @Test
    void testNextTokenOnContentDisposition() {
