...
public class Cleaner {
    ...
    static {
        CleanerImpl.setCleanerImplAccess(cleaner -> cleaner.impl);
    }
    ...
    public static Cleaner create() {
        ...
        cleaner.impl.start(cleaner, r -> new Thread(r, "Firefly-Cleaner-Thread"));
        return cleaner;
    }
    ...
    public interface Cleanable {
         ...
         * The cleanable cleaning action is invoked at most once
