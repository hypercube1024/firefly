...
public class FixedTimeLeakDetector<T> extends AbstractLifeCycle {
    ...
    public FixedTimeLeakDetector(long interval, long releaseTimeout, Action0 noLeakCallback) {
        this(Schedulers.createScheduler(), interval, interval, releaseTimeout, TimeUnit.SECONDS, noLeakCallback);
    }

    public FixedTimeLeakDetector(Scheduler scheduler, long initialDelay, long delay, long releaseTimeout, TimeUnit unit,
