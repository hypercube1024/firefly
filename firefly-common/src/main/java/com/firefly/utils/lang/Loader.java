...
public class Loader {
	 ...
	 * Load a class.
	 * <p>
	 * Load a class either from the thread context classloader or if none, the
	 * system loader
	 * </p>
	 * 
	 * @param name
	 *            the name of the new class to load
	 * @return Class
	 ...
	 * 
	 * @param loaderClass
	 *            a similar class, belong in the same classloader of the desired
	 *            class to load
	 * @param name
	 *            the name of the new class to load
	 * @return Class
