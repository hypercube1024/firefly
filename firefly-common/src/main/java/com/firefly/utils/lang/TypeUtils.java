...
public class TypeUtils {
	...
	/**
	 * @param o
	 *            Object to test for true
	 * @return True if passed object is not null and is either a Boolean with
	 *         value true or evaluates to a string that evaluates to true.
	 */
	 ...
	 * @return True if passed object is not null and is either a Boolean with
	 *         value false or evaluates to a string that evaluates to false.
	 */
