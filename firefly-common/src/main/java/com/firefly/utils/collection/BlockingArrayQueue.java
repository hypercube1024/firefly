 ...
 * </p>
 * <p>
 * Unlike {@link java.util.concurrent.ArrayBlockingQueue}, this class is able to
...
public class BlockingArrayQueue<E> extends AbstractList<E> implements BlockingQueue<E> {
    /**
     * The head offset in the {@link #_indexes} array, displaced by 15 slots to
     * avoid false sharing with the array length (stored before the first
     * element of the array itself).
     */
    private static final int HEAD_OFFSET = MemoryUtils.getIntegersPerCacheLine() - 1;
    /**
     * The tail offset in the {@link #_indexes} array, displaced by 16 slots
     * from the head to avoid false sharing with it.
     */
    ...
    /**
     * Array that holds the head and tail indexes, separated by a cache line to
     * avoid false sharing
     */
    ...
    /**
     * Creates an unbounded {@link BlockingArrayQueue} with default initial
    ...
    /**
     * Creates a bounded {@link BlockingArrayQueue} that does not grow. The
     * capacity of the queue is fixed and equal to the given parameter.
     *
    ...
    /**
     * Creates an unbounded {@link BlockingArrayQueue} that grows by the given
     * parameter.
     *
    ...
    /**
     * Create a bounded {@link BlockingArrayQueue} that grows by the given
     * parameter.
     *
     * @param capacity    the initial capacity
     * @param growBy      the growth factor
