...
public class JavaReflectionProxyFactory extends AbstractProxyFactory {
    ...
    protected ReflectUtils.FieldProxy _getFieldProxy(Field field) {
        try {
            ...
            if (fieldProxyClass == null) {
                ...
                return (ReflectUtils.FieldProxy) fieldProxyClass.getConstructor(Field.class).newInstance(field);
            }
        } catch (Throwable e) {
    ...
    protected ReflectUtils.MethodProxy _getMethodProxy(Method method) {
        try {
            ...
            return (ReflectUtils.MethodProxy) methodProxyClass.getConstructor(Method.class).newInstance(method);
        } catch (Throwable e) {
            throw new CommonRuntimeException(e);
        }
    }
    ...
    protected ReflectUtils.ArrayProxy _getArrayProxy(Class<?> clazz) {
        try {
            ...
            return (ReflectUtils.ArrayProxy) arrayProxyClazz.newInstance();
        } catch (Throwable e) {
            throw new CommonRuntimeException(e);
        }
    }
