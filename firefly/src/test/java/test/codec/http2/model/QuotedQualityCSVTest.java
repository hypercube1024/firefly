...
public class QuotedQualityCSVTest {
	...
	public void test7231_5_3_2_example4() {
		...
		Assert.assertThat(values,
				Matchers.contains("text/html;level=1", "text/html", "*/*", "text/html;level=2", "text/*"));
	}
	...
	public void test7231_5_3_4_example1() {
		...
		Assert.assertThat(values, Matchers.contains("compress", "gzip", "gzip", "gzip", "*", "compress", "identity"));
	}
