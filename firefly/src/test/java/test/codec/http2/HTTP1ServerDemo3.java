				...
				new HTTP1ServerConnectionListener() {
					...
					public HTTP1ServerRequestHandler onNewConnectionIsCreating() {
						return new HTTP1ServerRequestHandler.Adapter() {
							...
							@Override
							public boolean messageComplete(HTTPServerRequest request, HTTPServerResponse response, HTTP1ServerConnection connection) {
...
//								}
//								response.getFields().put(HttpHeader.CONTENT_LENGTH, String.valueOf(contentLength));
