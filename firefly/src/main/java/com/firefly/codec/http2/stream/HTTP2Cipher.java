...
public class HTTP2Cipher {
	...
	private final static Trie<Boolean> blackProtocols = new ArrayTrie<>(6 * 5);
	private final static Trie<Boolean> blackCiphers = new ArrayTrie<>(275 * 40);

	static {
		for (String p : new String[] {"TLSv1.1", "TLSv1", "SSL", "SSLv2", "SSLv3" }) {
			blackProtocols.put(p, Boolean.TRUE);
		}
