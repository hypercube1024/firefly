...
public interface StreamSPI extends Stream, Closeable {
    ...
    /**
     * @param listener the associated with this stream
     */
     ...
     * @param local  whether the update comes from a local operation (such as
     ...
     * </p>
     *
     * @param delta the delta value (positive or negative) to add to the stream
     *              send window
