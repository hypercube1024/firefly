...
public interface ServerHTTPHandler extends HTTPHandler {
	...
	public boolean accept100Continue(MetaData.Request request, MetaData.Response response, HTTPConnection connection);
	...
	public static class Adapter implements ServerHTTPHandler {
		...
		@Override
		public boolean accept100Continue(Request request, Response response, HTTPConnection connection) {
			return false;
		}
