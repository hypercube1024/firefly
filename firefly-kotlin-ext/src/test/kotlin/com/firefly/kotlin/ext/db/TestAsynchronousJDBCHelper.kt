...
class TestAsynchronousJDBCHelper {
    private val jdbcHelper: AsynchronousJDBCHelper
    private val size = 20
    ...
    init {
        ...
        jdbcHelper = AsynchronousJDBCHelper(ds)
    }
    ...
    fun testRollback() = runBlocking {
        ...
        val project = jdbcHelper.queryById<Project>(id)
