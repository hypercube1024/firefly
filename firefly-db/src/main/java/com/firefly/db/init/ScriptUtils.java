...
public abstract class ScriptUtils {
     ...
     * @param commentPrefix              the prefix that identifies SQL line comments &mdash; typically
     *                                   "--"; never {@code null} or empty
     * @param blockCommentStartDelimiter the <em>start</em> block comment delimiter; never {@code null}
     *                                   or empty
